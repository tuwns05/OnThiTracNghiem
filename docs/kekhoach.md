...
# Tổng quan
## Học sinh
- học sinh sẽ tạo tài khoản và đăng kí bằng email
- bắt đầu ôn tập cá tài liệu giáo viên gửi, thi thử bằng ngân hàng câu hỏi mà giao viên cung cấp
- sẽ có hộp thư nhận những thông báo như: giáo viên đã gửi đề, dã update bộ đề trắc nghiệm để ôn tập, thông báo thời gian kiểm tra, ...
## Giáo viên
- Giáo viên sẽ được admin cấp tài khoản ứng với vai trò của giáo viên(giáo viên toán sẽ khác với giao vien anh)
- cập nhập thông tin cá nhân
- thêm và xóa các tài liệu, bộ đề thi thử 
- tổ chức cac bài thi thử
```
...
- Gửi thông báo đến lớp/nhóm/cá nhân(các thông báo như lịch thi, giờ thi, thông báo giờ học, gửi tài tài liệu học tập)
...
## 3. Giáo viên cấp cao (Admin) // không biết nên bỏ hay giữ lại
